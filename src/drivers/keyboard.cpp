...
KeyBoardDriver::KeyBoardDriver(InterruptManager* manger, KeyBoardEventHandler* handler) 
    : InterruptHandler(0x01 + manger->HardwareInterruptOffset(), manger),
    dataport(0x60),
    commandport(0x64),
    handler(handler) {
